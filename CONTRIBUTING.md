...
- Write clear and concise commit messages following the [Semantic Commit Messages](Docs/Semantic%20Commit%20Messages.md) guidelines.

### 4. Commit Changes

Ensure your commit messages follow the [Semantic Commit Messages](Docs/Semantic%20Commit%20Messages.md) format. Example:

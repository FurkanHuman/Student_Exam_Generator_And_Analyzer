...
{
    internal static void StudentPreTop(Analysis analysisHeader, ColumnDescriptor generalClassInfoForStudent)
    {
    ...
    internal static void DrawStudensAndNotes(Analysis analysisHeader, ColumnDescriptor generalClassInfoForStudent)
    {
        int sequence = 1;
    ...
    internal static void ClassScoreSummary(ColumnDescriptor generalClassInfoForStudent, Analysis analysisHeader, char[] crayzChar)
    {
    ...
    private static void QuestionPerDividedStudents(Analysis analysisHeader, RowDescriptor css, char[] crayzChar)
    {
